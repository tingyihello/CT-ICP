...
namespace ct_icp {
    ...
    struct CTICPOptions {
        ...
        double power_planarity = 2.0; // The power of planarity defined in the weighting scheme 平面性的权重
        ...
        int min_num_residuals = 100; // Below this number, CT_ICP will crash  小于这个值，ICP优化会停止
